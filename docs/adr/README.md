...
| [0036](0036-a-template-may-offer-a-directory.md) | A template may offer a **directory** and a caller may name one file in it — so an uploaded volume file becomes a run **without the service ever receiving the file** |
